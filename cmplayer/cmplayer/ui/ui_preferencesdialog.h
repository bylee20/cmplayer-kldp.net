...
public:
    ...
    Pref__Ui__PreferencesDialog->resize(426, 428);
    ...
    QIcon icon3;
    icon3.addPixmap(QPixmap(QString::fromUtf8(":/img/applications-multimedia-big.png")), QIcon::Normal, QIcon::Off);
    ...
    list->item(3)->setText(QApplication::translate("Pref::Ui::PreferencesDialog", "\354\236\254\354\203\235\354\227\224\354\247\204", 0, QApplication::UnicodeUTF8));
