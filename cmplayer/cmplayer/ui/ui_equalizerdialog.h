...
public:
    ...
    Ui__EqualizerDialog->resize(252, 180);
    ...
    horizontalSlider_5->setMinimum(-200);
    ...
    brightness_spin->setMinimum(-200);
    brightness_spin->setMaximum(200);
    ...
    horizontalSlider_6->setMinimum(-200);
    ...
    contrast_spin->setMinimum(-200);
    contrast_spin->setMaximum(200);
    ...
    horizontalSlider_8->setMinimum(-200);
    horizontalSlider_8->setMaximum(200);
    horizontalSlider_8->setOrientation(Qt::Horizontal);
    horizontalSlider_8->setTickPosition(QSlider::NoTicks);

    gridLayout->addWidget(horizontalSlider_8, 2, 1, 1, 1);

    hue_spin = new QSpinBox(Ui__EqualizerDialog);
    hue_spin->setObjectName(QString::fromUtf8("hue_spin"));
    hue_spin->setAccelerated(true);
    hue_spin->setMinimum(-200);
    hue_spin->setMaximum(200);
    hue_spin->setValue(0);

    gridLayout->addWidget(hue_spin, 2, 2, 1, 1);
    ...
    horizontalSlider_9->setMinimum(-200);
    ...
    gridLayout->addWidget(horizontalSlider_9, 3, 1, 1, 1);
    ...
    saturation_spin->setMinimum(-200);
    saturation_spin->setMaximum(200);
