...
//	QWidgetVideoSink *self = GST_QWIDGET_VIDEO_SINK(sink);
//	if (buffer != 0 && self->sink) {
//		NewFrameEvent *event = 0;
//		VideoFrame *frame = new VideoFrame();
//		VideoFrame::Info info;
//		info.setSize(self->width, self->height);
//		switch (self->fourcc) {
//		case GST_MAKE_FOURCC('I', '4', '2', '0'):
//			info.type = VideoFrame::I420;
//			break;
//		case GST_MAKE_FOURCC('Y', 'V', '1', '2'):
//			info.type = VideoFrame::YV12;
//			break;
//		case GST_MAKE_FOURCC('Y', 'U', 'Y', '2'):
//			info.type = VideoFrame::YUY2;
//			break;
//		default:
//			info.type = VideoFrame::NoFrame;
//			break;
//		}
//		info.pixelAspectRatio = self->pixelAspect;
//		frame->setInfo(info);
//		frame->setData(buffer->data, buffer->size);
//		event = new NewFrameEvent(*frame);
//		delete frame;
