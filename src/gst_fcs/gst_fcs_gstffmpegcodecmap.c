...
#include "gst_fcs_avcodec.h"
#include "gst_fcs_gstffmpegcodecmap.h"
...
//    return;
  ...
  if (gst_structure_has_name (structure, "video/x-raw-yuv")) {
    ...
    if (gst_structure_get_fourcc (structure, "format", &fourcc)) {
	  ...
	  return PIX_FMT_YVU410P;
          break;
        case GST_MAKE_FOURCC ('v', '3', '0', '8'):
	  return PIX_FMT_V308;
          break;
        case GST_MAKE_FOURCC ('A', 'Y', 'U', 'V'):
	  return PIX_FMT_AYUV4444;
          break;
    ...
    if (gst_structure_get_int (structure, "bpp", &bpp) &&
      ...
      if (gst_structure_get_int (structure, "red_mask", &rmask)) {
		...
		return PIX_FMT_xRGB32;
              else              // if (rmask == 0x000000ff)
		return PIX_FMT_BGRx32;
#else
              if (rmask == 0x0000ff00)
		return PIX_FMT_RGB32;
              else if (rmask == 0x00ff0000)
    ...
    if (gst_structure_get_int (structure, "bpp", &bpp)) {
	  ...
	  return PIX_FMT_GRAY8;
        ...
        case 16:{
	      ...
	      return PIX_FMT_GRAY16_L;
            else if (endianness == G_BIG_ENDIAN)
	      return PIX_FMT_GRAY16_B;
          }
        }
          break;
      }
...
//void
//gst_ffmpegcsp_caps_with_codectype (const GstCaps * caps, AVCodecContext * context)
//{
//  if (context == NULL)
//    return;
//
